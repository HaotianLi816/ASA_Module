...
from UNet import UNet16, input_size
import matplotlib.pyplot as plt
import argparse
from os.path import join
from PIL import Image
import gc
from utils import load_unet_vgg16, load_unet_resnet_101, load_unet_resnet_34, load_unet_resnet_18, load_SegNet, load_unet_resnet_50, load_pspnet_res18, load_pspnet_res34
...
def evaluate_img(model, img):
    ...
    X = Variable(X.unsqueeze(0)).cuda()  # [1, C, H, W]
...
if __name__ == '__main__':
    ...
    parser.add_argument('-img_dir',type=str, default='E:\\medical datasets\\Spleen\\Testing\\images', help='input dataset directory')
    parser.add_argument('-model_path', type=str, default='E:\\medical datasets\\lstm-net\\1_spleen_pspnet_lstm\\model_best.pt',help='traz`ined model path')
    parser.add_argument('-model_type', type=str, default='pspnet_res34', choices=['vgg16', ' resnet18', 'resnet34', 'resnet50', 'segnet', 'densenet57', 'pspnet_res34', 'pspnet_res18'])
    parser.add_argument('-out_viz_dir', type=str, default='E:\\medical datasets\\Spleen\\Testing\\1_spleen_pspnet_lstm\\visualization_output',  help='visualization output dir')
    parser.add_argument('-out_pred_dir', type=str, default='E:\\medical datasets\\Spleen\\Testing\\1_spleen_pspnet_lstm\\prediction_output', required=False,  help='prediction output dir')
    parser.add_argument('-threshold', type=float, default=0.24, help='threshold to cut off crack response')
    ...
    if args.model_type == 'vgg16':
        ...
        model = load_unet_resnet_18(args.model_path)
    elif args.model_type  == 'resnet50':
        model = load_unet_resnet_50(args.model_path)
    elif args.model_type == 'segnet':
        model = load_SegNet(args.model_path)
    elif args.model_type == 'pspnet_res34':
        model = load_pspnet_res34(args.model_path)
    elif args.model_type == 'pspnet_res18':
        model = load_pspnet_res18(args.model_path)
    else:
